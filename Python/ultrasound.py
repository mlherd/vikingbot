...
...
# This class is also for the ultrasound distance sensor data read
# It is more flexable than the other one
# Since it is not fully tested it yet, this class is not used
